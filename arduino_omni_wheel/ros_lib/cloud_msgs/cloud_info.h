...
namespace cloud_msgs
{
  ...
  class cloud_info : public ros::Msg
  {
    ...
    cloud_info():
      header(),
      startRingIndex_length(0), st_startRingIndex(), startRingIndex(nullptr),
      endRingIndex_length(0), st_endRingIndex(), endRingIndex(nullptr),
      startOrientation(0),
      endOrientation(0),
      orientationDiff(0),
      segmentedCloudGroundFlag_length(0), st_segmentedCloudGroundFlag(), segmentedCloudGroundFlag(nullptr),
      segmentedCloudColInd_length(0), st_segmentedCloudColInd(), segmentedCloudColInd(nullptr),
      segmentedCloudRange_length(0), st_segmentedCloudRange(), segmentedCloudRange(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "cloud_msgs/cloud_info"; };
    virtual const char * getMD5() override { return "af8fdf3af62b4ae75761d0e92aa4cf43"; };
