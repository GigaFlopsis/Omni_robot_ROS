...
namespace mav_msgs
{
  ...
  class Actuators : public ros::Msg
  {
    ...
    Actuators():
      ...
      angular_velocities_length(0), st_angular_velocities(), angular_velocities(nullptr),
      normalized_length(0), st_normalized(), normalized(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "mav_msgs/Actuators"; };
    virtual const char * getMD5() override { return "25741daf38ed25442e3a66a855ee8d9c"; };
