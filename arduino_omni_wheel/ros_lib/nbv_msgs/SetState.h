...
static const char SETSTATE[] = "nbv_msgs/SetState";
  ...
  class SetStateRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return SETSTATE; };
    virtual const char * getMD5() override { return "1a8bf0f4fa25ab2514d8da707569e382"; };
