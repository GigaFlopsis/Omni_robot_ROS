...
namespace cartographer_ros_msgs
{
  ...
  class SensorTopics : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "cartographer_ros_msgs/SensorTopics"; };
    virtual const char * getMD5() override { return "bafbff7d66e3eeeb8d4a9195096cba08"; };
