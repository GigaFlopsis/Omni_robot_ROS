...
namespace cartographer_ros_msgs
{
  ...
  class TrajectoryOptions : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "cartographer_ros_msgs/TrajectoryOptions"; };
    virtual const char * getMD5() override { return "7eda9b62c16c18fa1563587e73501e47"; };
