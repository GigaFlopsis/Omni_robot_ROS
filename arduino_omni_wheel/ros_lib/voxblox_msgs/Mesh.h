...
namespace voxblox_msgs
{
  ...
  class Mesh : public ros::Msg
  {
    ...
    Mesh():
      header(),
      block_edge_length(0),
      mesh_blocks_length(0), st_mesh_blocks(), mesh_blocks(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return "voxblox_msgs/Mesh"; };
    virtual const char * getMD5() override { return "4d589d8b6bcff9e45d11686cdd6227df"; };
