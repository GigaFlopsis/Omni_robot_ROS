...
namespace voxblox_msgs
{
  ...
  class VoxelEvaluationDetails : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "voxblox_msgs/VoxelEvaluationDetails"; };
    virtual const char * getMD5() override { return "ae63ff7a8fed6761c7b2408516d56b79"; };
